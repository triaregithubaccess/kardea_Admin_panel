...
import {   api_domen, image_upload_url2 } from '../../../api/api';
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      if (!this.checkAllSuccess()) {
        this.$message('Please wait for all pictures to upload successfully or there is a network problem, please refresh the page to re-upload!')
        return
      }
